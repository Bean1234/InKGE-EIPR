...
def evaluate(my_model, target, epoch, init_emb_ent, init_emb_rel, relation_triplets,G_test):
    with torch.no_grad():
        my_model.eval()
        ...
        for triplet in tqdm(sup):
            ...
            head_scores = my_model.score(emb_ent, emb_rel, head_corrupt,G_test)
            ...
            tail_scores = my_model.score(emb_ent, emb_rel, tail_corrupt,G_test)
